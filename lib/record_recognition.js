...
record_recognition.record_finish = function(data){
    ...
    setTimeout(
        ...
        60*1000 + each_speech_duration*2
    )
...
record_recognition.save_startdata = function(data){
...
record_recognition.get_remote_file_name_raw = function(event_id, role, speech_id, short_split_id){
  return get_remote_file_name_raw(event_id, role, speech_id, short_split_id)
}
...
function  convert_rawfile_to_unique_samplinrate_wav(data, short_split_id, sample_rate){
