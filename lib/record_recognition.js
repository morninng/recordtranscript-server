...
class RecordRecognition {
    constructor() {
        ...
        this.get_firebasepath_speechcontext_2 = (event_id, deb_style, role, speech_id) => {
            return "event_related/audio_transcriptserver_2/" + event_id + "/" + deb_style + "/" + role + "/" + speech_id + "/spech_context/";
        };
        this.get_firebasepath_audio_2 = (event_id, deb_style, role, speech_id) => {
            return "event_related/audio_transcriptserver_2/" + event_id + "/" + deb_style + "/" + role + "/" + speech_id + "/audio/";
        };
        this.get_firebasepath_shortsplitid_2 = (event_id, deb_style, role, speech_id, short_split_id) => {
        ...
        this.get_firebasepath_transcriptcontext_2 = (event_id, deb_style, role, speech_id, short_split_id) => {
            const shortsplitid_path = this.get_firebasepath_shortsplitid_2(event_id, deb_style, role, speech_id, short_split_id);
        ...
        this.asyncRecognizeGCS = (gcsUri, encoding, sampleRateHertz, languageCode, data) => {
            const speech_id = data.speech_id;
        ...
        this.save_transcription_2 = (transcription, data) => {
